...
// Input  :
// Output :
// Edited : Lettuce: This was changed and taken from the assassin code as the original from the leak does not work.
//(Regarding the hit detection)
//-----------------------------------------------------------------------------
