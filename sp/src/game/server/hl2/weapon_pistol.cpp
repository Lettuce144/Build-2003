...
void CWeaponPistol::AddViewKick( void )
{
	...
	viewPunch.x = random->RandomFloat(-2.0f, -1.0f); // viewPunch.x = random->RandomFloat( 0.25f, 0.5f );
	viewPunch.y = random->RandomFloat(0.5f, 1.0f); // viewPunch.y = random->RandomFloat( -.6f, .6f );
	viewPunch.z = 0.0f;
