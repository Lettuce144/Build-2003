...
class CHUDQuickInfoOld : public CHudElement, public vgui::Panel
{
	DECLARE_CLASS_SIMPLE(CHUDQuickInfoOld, vgui::Panel);
public:
	CHUDQuickInfoOld(const char* pElementName);
	void Init(void);
	void VidInit(void);
...
DECLARE_HUDELEMENT(CHUDQuickInfoOld);

CHUDQuickInfoOld::CHUDQuickInfoOld(const char* pElementName) :
...
void CHUDQuickInfoOld::ApplySchemeSettings(IScheme* scheme)
{
...
void CHUDQuickInfoOld::Init(void)
{
	m_ammoFade = 0.0f;
	m_healthFade = 0.0f;
	m_fFade = 0.0f;
...
void CHUDQuickInfoOld::VidInit(void)
{
	Init();
...
void CHUDQuickInfoOld::DrawWarning(int x, int y, CHudTexture* icon, float& time)
{
...
//-----------------------------------------------------------------------------
bool CHUDQuickInfoOld::ShouldDraw(void)
{
...
// Purpose: 
//-----------------------------------------------------------------------------
void CHUDQuickInfoOld::UpdateEventTime(void)
{
...
//-----------------------------------------------------------------------------
bool CHUDQuickInfoOld::EventTimeElapsed(void)
{
