...
//Fuck you mapbase
LINK_ENTITY_TO_CLASS( viewmodel, CPredictedViewModel );
...
BEGIN_PREDICTION_DATA(CPredictedViewModel)
#ifdef CLIENT_DLL
...
// Purpose: 
//-----------------------------------------------------------------------------
void CPredictedViewModel::RemoveViewmodelAddon(void)
{
	m_iViewModelAddonModelIndex = -1;
}
...
#ifdef CLIENT_DLL
void CPredictedViewModel::ProcessMuzzleFlashEvent(void)
{
...
// Purpose: 
//-----------------------------------------------------------------------------
void CPredictedViewModel::OnDataChanged(DataUpdateType_t updateType)
{
...
// Purpose: 
//-----------------------------------------------------------------------------
void CPredictedViewModel::SetDormant(bool bDormant)
{
...
// Purpose: 
//-----------------------------------------------------------------------------
void CPredictedViewModel::UpdateOnRemove(void)
{
...
//-----------------------------------------------------------------------------
int CPredictedViewModel::DrawModel(int flags)
{
...
// Purpose: 
//-----------------------------------------------------------------------------
int CPredictedViewModel::InternalDrawModel(int flags)
{
	CMatRenderContextPtr pRenderContext(materials);

	//Todo: Fix comment this out
...
// Purpose: 
//-----------------------------------------------------------------------------
bool CPredictedViewModel::OnInternalDrawModel(ClientModelRenderInfo_t* pInfo)
{
...
// Purpose
//-----------------------------------------------------------------------------
void CPredictedViewModel::FireEvent(const Vector& origin, const QAngle& angles, int event, const char* options)
{
...
// Purpose
//-----------------------------------------------------------------------------
void CPredictedViewModel::CalcViewModelCollision(Vector& origin, QAngle& angles, CBasePlayer* owner)
{
