...
ConVar  sk_ar2_grenade_radius("sk_ar2_grenade_radius", "0", FCVAR_REPLICATED);
...
CAmmoDef *GetAmmoDef()
{
	...
	if ( !bInitted )
	{
		...
		def.AddAmmoType("SMG1_	Grenade", DMG_BURN, TRACER_NONE, "sk_plr_dmg_smg1_grenade", "sk_npc_dmg_smg1_grenade", "sk_max_smg1_grenade", 0, 0);
		def.AddAmmoType("SniperRound", DMG_BULLET | DMG_SNIPER, TRACER_NONE, "sk_plr_dmg_sniper_round", "sk_npc_dmg_sniper_round", "sk_max_sniper_round", BULLET_IMPULSE(650, 6000), 0);
		def.AddAmmoType("slamammo", DMG_BURN, TRACER_NONE, 0, 0, "sk_max_slam", 0, 0);
		...
		def.AddAmmoType("Gasoline", DMG_BURN, TRACER_NONE, 0, 0, 100, 0, 0);
